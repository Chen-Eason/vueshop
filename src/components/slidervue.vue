  ...
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      <ul class="container" :style="containerStyle">
        ...
        <li v-for="(item, index) in sliders" :key="index" class="item-img">
      ...
      <ul class="direction">
        <li class="left" @click="move(640, 1, speed)">
        ...
        <li class="right" @click="move(640, -1, speed)">
...
export default {
  ...
  data () {
    return {
      sliders:[
        {
          img:require('../assets/tupian/ban1.jpg')
        },
        {
          img:require('../assets/tupian/ban2.jpg')
        },
        {
          img:require('../assets/tupian/ban3.jpg')
        }
      ],
      currentIndex:1,
      distance:-640,
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/640 : this.currentIndex -= offset/640
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -1920) this.distance = -640
          if (des > -640) this.distance = -1920
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1
      const offset = Math.abs(index - this.currentIndex) * 640
